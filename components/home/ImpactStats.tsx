      ...
      <Reveal className="mx-auto mb-[70px] flex max-w-[1320px] flex-wrap items-end justify-between gap-12">
        <div>
          ...
          <PlainHeading
            ...
            className="mb-0 mt-4 text-[48px] leading-[1.08] tracking-[-0.5px] max-md:text-[32px]"
          />
        </div>
        ...
        {content.stats.map((stat) => {
          ...
          return (
            ...
            <div key={stat.key} className="flex flex-col-reverse">
              <dt className="mt-[14px] text-[12.5px] tracking-[1.5px] text-muted-soft">
                {stat.label}
              </dt>
              <dd className="m-0 font-heading text-[68px] font-medium leading-none">
