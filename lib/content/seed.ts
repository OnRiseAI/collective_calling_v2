...
/**
 * Seed homepage content. This is the canonical fallback rendered when no CMS is
 * configured or a CMS read fails. Real facts are kept verbatim. Testimonials are
 * flagged `placeholder: true` and must be replaced with real supporter quotes
 * before launch (spec section 10).
 */
